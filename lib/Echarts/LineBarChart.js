...
var LineBarChart = function (_Basic) {
  _inherits(LineBarChart, _Basic);

  function LineBarChart() {
    _classCallCheck(this, LineBarChart);

    return _possibleConstructorReturn(this, (LineBarChart.__proto__ || Object.getPrototypeOf(LineBarChart)).apply(this, arguments));
  }
  ...
  _createClass(LineBarChart, [{
    ...
    value: function getOption(props) {
      ...
      config.y.forEach(function (yItem, yIndex) {
        yItem.data && yItem.data.forEach(function (item, index) {
          // legend
